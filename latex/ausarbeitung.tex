...
OpenStack ist eher ein Framework, es muss durch eigene Entwicklung angepasst werden und man muss sich hierbei besser auskennen.\cite{OSundAVerg} OpenStack wird desweiteren eher von grossen Firmen verwendet, und auf Grund der Komplezität auch oft über einen Provider verwendet. \cite{allthreeverg}. \\
...
Unterstützer / Eigentümer  & Apache & HP, Amazon & Open Source \\ 
